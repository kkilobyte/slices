...
// ToStrings creates a new string slice with all the given slice's values,
// converted to strings using fmt.Sprintf("%v", value) unless the value is
// of type rune, string, []byte or []rune, in which case they're simply recast
// as string
